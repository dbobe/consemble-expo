...
export const DEV_QUESTS_ID = 'co_zcG4cSqHrVH3HkpYz4T7ka1VAhP' as ID<typeof ListOfQuests>;

// Production environment quest list ID
export const PROD_QUESTS_ID = 'co_zauJ3s4WiHajEFZGfWvgR4UjSZL' as ID<typeof ListOfQuests>;

// Use the appropriate ID based on environment
const ENV = process.env.EXPO_PUBLIC_ENV || 'development';

export const ALL_QUESTS_ID = ENV === 'production' ? PROD_QUESTS_ID : DEV_QUESTS_ID;
